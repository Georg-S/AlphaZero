...
bool chess::Piece::isFieldEmpty(chess::Piece *(*board)[8], const int &x, const int &y) {
    return board[x][y] == nullptr;
}

bool chess::Piece::piecesHaveDifferentColor(chess::Piece *(*board)[8], const int &fromX, const int &fromY,
...
bool chess::Piece::isCheck(chess::Piece *(*board)[8], const int &kingX, const int &kingY) {
