...
bool
Rook::rightPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
    if (fromX >= toX)
        return false;
...
bool Rook::upPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
...
bool Rook::leftPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
    if (fromX <= toX)
        return false;
...
bool Rook::downPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
