...
bool
Bishop::leftUpPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
...
bool Bishop::leftDownPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX,
                              const int &toY) {
...
bool Bishop::rightDownPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX,
                               const int &toY) {
...
bool
Bishop::rightUpPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
