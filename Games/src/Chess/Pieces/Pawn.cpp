...
bool Pawn::normalMovementStrategyPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX,
                                    const int &toY) {
...
bool
Pawn::normalMovementStrategyForBlackPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX,
                                       const int &toY) {
...
bool Pawn::normalMovementStrategyForWhitePossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY,
...
bool
Pawn::enPassantPossible(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX, const int &toY,
                        const int &direction) {
...
bool
Pawn::isEnPassantMove(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
...
void Pawn::updateEnPassantDirection(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &toX,
                                    const int &toY) {
    if(abs(fromY- toY) != 2)
        return;
...
void Pawn::updateEnPassant(chess::Piece *(*board)[8], const int &fromX, const int &fromY, const int &updatePawnX,
                           const int &updatePawnY) {
