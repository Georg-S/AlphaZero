...
bool King::normalMovePossible(chess::Piece* board[8][8], const int &fromX, const int &fromY, const int &toX,
                              const int &toY) {
...
bool
King::castlingPossible(chess::Piece* board[8][8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
    if(moved || fromY != toY)
        return false;
    if(abs(fromX - toX) != 2)
        return false;
...
bool King::isValidRookForCastlingField(chess::Piece* board[8][8], const int &rookX, const int &rookY) {
...
bool
King::testCheckOnPositionAndResetBoard(chess::Piece* board[8][8], const int &fromX, const int &fromY, const int &toX,
                                       const int &toY) {
...
bool King::isCastlingMove(const int &fromX, const int &toX) {
    return (abs(fromX - toX) == 2);
}

void
King::makeCastlingMove(chess::Piece* board[8][8], const int &fromX, const int &fromY, const int &toX, const int &toY) {
