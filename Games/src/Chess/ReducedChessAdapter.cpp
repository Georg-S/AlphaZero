...
std::vector<int> ReducedChessAdapter::getAllPossibleMoves(const std::string &state, const int &currentPlayer) {
...
int ReducedChessAdapter::getNextPlayer(const int &currentPlayer) {
    return (int)(chess::GameLogic::getNextPlayer((chess::PieceColor)currentPlayer));
}

std::string ReducedChessAdapter::makeMove(const std::string &state, const int &move, const int &currentPlayer) {
    chess::Board board = convertStateStringToBoard(state);
...
torch::Tensor ReducedChessAdapter::convertStateToNeuralNetInput(const std::string &state, const int &currentPlayer,
                                                                torch::Device device) {
    chess::Board board = convertStateStringToBoard(state);
...
int ReducedChessAdapter::gameOverReward(const std::string &state, const int &currentPlayer) {
    chess::Board board = convertStateStringToBoard(state);
    int value = 0;
...
void ReducedChessAdapter::replacePawnsWithQueens(chess::Board &board, const int &row) {
    for(int x = 0; x < 8; x++) {
