...
void chess::Renderer::renderPiece(const chess::Board &board, const int &x, const int &y) {
...
void chess::Renderer::renderPieceOnMousePosition(chess::Piece *piece, const int &mouseX, const int &mouseY) {
