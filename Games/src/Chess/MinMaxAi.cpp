...
void chess::MinMaxAi::getAllPossibleMovesForPiece(chess::Board &board, const int &fromX, const int &fromY,
...
void chess::MinMaxAi::replacePawnsInRowWithQueens(chess::Board &board, const int &row) {
    for(int x = 0; x < 8; x++) {
