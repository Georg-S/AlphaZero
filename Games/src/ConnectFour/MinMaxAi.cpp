...
int
cn4::MinMaxAi::evaluateBoardPosition(const cn4::Board &board, const int &x, const int &y) {
...
int cn4::MinMaxAi::rightHorizontalValue(const cn4::Board &board, const int &x, const int &y) {
    if (x + 3 >= board.width)
        return 0;
...
int cn4::MinMaxAi::rightDiagonalDownValue(const cn4::Board &board, const int &x, const int &y) {
...
int cn4::MinMaxAi::rightDiagonalUpValue(const cn4::Board &board, const int &x, const int &y) {
    if (x + 3 >= board.width)
        return 0;
    if (y + 3 >= board.height)
        return 0;
...
int cn4::MinMaxAi::upVerticalValue(const cn4::Board &board, const int &x, const int &y) {
    if (y + 3 >= board.height)
        return 0;
