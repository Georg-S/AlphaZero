...
std::string ConnectFourAdapter::makeMove(const std::string &state, const int &move, const int &currentPlayer) {
...
int ConnectFourAdapter::gameOverReward(const std::string &state, const int &currentPlayer) {
...
int ConnectFourAdapter::getNextPlayer(const int &currentPlayer) {
...
std::vector<int> ConnectFourAdapter::getAllPossibleMoves(const std::string &state, const int &currentPlayer) {
...
torch::Tensor ConnectFourAdapter::convertStateToNeuralNetInput(const std::string &state, const int &currentPlayer,
                                                               torch::Device device) {
    cn4::Board board = convertStringToBoard(state);
