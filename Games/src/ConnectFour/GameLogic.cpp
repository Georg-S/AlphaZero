...
bool cn4::GameLogic::fourInARowHorizontal(const cn4::Board &board, const int &player) {
...
bool
cn4::GameLogic::fourInARowHorizontal(const cn4::Board &board, const int &player, const int &xPos, const int &yPos) {
...
bool cn4::GameLogic::fourInARowVertical(const cn4::Board &board, const int &player) {
    for(int x = 0; x < board.width; x++) {
        for(int y = 0; y < board.height; y++) {
            if(board.board[x][y] == NONE)
                break;
...
bool cn4::GameLogic::fourInARowVertical(const cn4::Board &board, const int &player, const int &xPos, const int &yPos) {
...
bool cn4::GameLogic::fourInARowDiagonal(const cn4::Board &board, const int &player) {
    for(int x = 0; x < board.width; x++) {
        for(int y = 0; y < board.height; y++){
...
bool
cn4::GameLogic::fourInARowDiagonalUp(const cn4::Board &board, const int &player, const int &xPos, const int &yPos) {
...
bool
cn4::GameLogic::fourInARowDiagonalDown(const cn4::Board &board, const int &player, const int &xPos, const int &yPos) {
...
void cn4::GameLogic::makeMove(cn4::Board &board, const int &action, const cn4::PlayerColor &playerColor) {
...
bool cn4::GameLogic::isMovePossible(const cn4::Board &board, const int &action) {
