...
void cn4::Renderer::renderPiece(const cn4::Board &board, const int &x, const int &y) {
...
int cn4::Renderer::convertBoardXPositionToRenderXPosition(const cn4::Board &board, const int &x) {
    int result = (windowWidth / board.width) * x;

    return result;
}

int cn4::Renderer::convertBoardYPositionToRenderYPosition(const cn4::Board &board, const int &y) {
