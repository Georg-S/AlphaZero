...
namespace cn4{
    ...
    private:
        ...
        int evaluateBoardPosition(const cn4::Board &board, const int &x, const int &y);

        int rightHorizontalValue(const cn4::Board &board,  const int &x, const int &y);
        int rightDiagonalDownValue(const cn4::Board &board,  const int &x, const int &y);
        int rightDiagonalUpValue(const cn4::Board &board,  const int &x, const int &y);
        int upVerticalValue(const cn4::Board &board,  const int &x, const int &y);
