...
void
MonteCarloTreeSearch::search(const int &count, std::string strState, NeuralNetwork *net, Game *game, int currentPlayer, torch::DeviceType device) {
...
std::vector<float> MonteCarloTreeSearch::getProbabilities(const std::string &state, const float &temperature) {
...
float MonteCarloTreeSearch::expandNewEncounteredState(const std::string &strState, const int &currentPlayer, Game* game, NeuralNetwork* net, torch::DeviceType device) {
...
int MonteCarloTreeSearch::getActionWithHighestUpperConfidenceBound(const std::string &strState, const int &currentPlayer, Game *game) {
...
float MonteCarloTreeSearch::calculateUpperConfidenceBound(const std::string &strState, const int &action) {
